...
export default function Useradmin() {
    ...
    if (isLoggedInVariable == ""){
        return <div >
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh',backgroundImage: "url('/cupcake.jpg')", backgroundPosition: "right bottom", backgroundSize: "auto"}}>
            <div style={{}}>
