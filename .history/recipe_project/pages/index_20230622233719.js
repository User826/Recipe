...
export default function Useradmin() {
    ...
    if (isLoggedInVariable == ""){
        return <div >
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width:'100vw', height: '100vh',backgroundImage: "url('/cupcake.jpg')", backgroundPosition: "right bottom", backgroundSize: "cover", backgroundRepeat: "no-repeat"}}>
            <div style={{}}>
